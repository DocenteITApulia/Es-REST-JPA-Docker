...
public class BookController {
    ...
    @GetMapping("/ricerca")
    public ResponseEntity<List<Libro>> getLibriByParola(@RequestParam String parziale){
        //TODO avrebbe senso imporre limite massimo e minimo della parola
        return ResponseEntity.ok().body(bookService.findLibroContainingString(parziale));
    }
    ...
    @GetMapping("/{bookId}")
    public ResponseEntity<Libro> getLibroById(@PathVariable Long bookId){
